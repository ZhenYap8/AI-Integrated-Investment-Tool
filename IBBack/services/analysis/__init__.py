...
class FinancialAnalyzer:
    ...
    def analyze_company(self, ticker: str, years: Optional[int], thresh: Dict[str, float], period=None) -> AnalyzeResponse:
    ...
    def analyze_industry(self, industry: str, years: Optional[int], thresh: Dict[str, float], period=None) -> AnalyzeResponse:
